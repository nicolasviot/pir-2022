...
ParentProcess*
Waypoint (ParentProcess *p, const string &n, djnn::CoreProcess* cpnt_0, double d_var_0, double d_var_1)
{
	auto* cpnt_1 = new Component (p, n);
	auto* cpnt_2 = new FillColor (cpnt_1, "fill", 0, 255, 0);
	...
	auto* cpnt_6 = new FSM (nullptr, "drag_Waypoint");
	...
	cpnt_1->add_child (dynamic_cast<FatChildProcess*>(cpnt_6), "drag_Waypoint");
	return cpnt_1;
}

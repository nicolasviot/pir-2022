...
struct nat_src_side_cpp_0_struct : public NativeExpressionAction {
	nat_src_side_cpp_0_struct (ParentProcess *p, const djnn::string &n, bool string_setter, bool isModel)
...
void
nat_src_side_cpp_0_struct::impl_activate ()
{
	col->set_value(((AbstractProperty*)col)->get_double_value () + ((AbstractProperty*)x_state)->get_double_value () / 300, 1);
};


struct nat_src_side_cpp_1_struct : public NativeExpressionAction {
	nat_src_side_cpp_1_struct (ParentProcess *p, const djnn::string &n, bool string_setter, bool isModel)
      : NativeExpressionAction (p, n, isModel), _string_setter (string_setter)
    {
      set_is_model (isModel);
...
void
nat_src_side_cpp_1_struct::impl_activate ()
{
	wi->set_value(((AbstractProperty*)wi)->get_double_value () - (((AbstractProperty*)x_state)->get_double_value ()), 1);
};


struct nat_src_side_cpp_2_struct : public NativeExpressionAction {
	nat_src_side_cpp_2_struct (ParentProcess *p, const djnn::string &n, bool string_setter, bool isModel)
      : NativeExpressionAction (p, n, isModel), _string_setter (string_setter)
    {
      set_is_model (isModel);
...
side (ParentProcess *p, const string &n, double d_var_0, double d_var_1)
{
	...
	alias (cpnt_0, "wi", dynamic_cast<FatChildProcess*>(cpnt_4->find_child ("width")));
	auto *cpnt_7 = cpnt_0->find_child ( "wi");
	...
	auto *cpnt_14 = new nat_src_side_cpp_0_struct (cpnt_10, "", true, 0);
	...
	auto *cpnt_17 = new nat_src_side_cpp_1_struct (cpnt_10, "", true, 0);
	if (cpnt_7->get_process_type() != PROPERTY_T) {
		djnn__error (cpnt_7, "is not a property\n");
		exit(0);
	}
		cpnt_17->wi = dynamic_cast<AbstractProperty*>(cpnt_7);
	...
	auto *cpnt_20 = new nat_src_side_cpp_2_struct (cpnt_10, "", true, 0);

...
struct nat_src_side_bas_cycle_cpp_0_struct : public NativeExpressionAction {
	nat_src_side_bas_cycle_cpp_0_struct (ParentProcess *p, const djnn::string &n, bool string_setter, bool isModel)
...
void
nat_src_side_bas_cycle_cpp_0_struct::impl_activate ()
{
	col->set_value(((AbstractProperty*)col)->get_double_value () - ((AbstractProperty*)x_state)->get_double_value () / 300, 1);
};


struct nat_src_side_bas_cycle_cpp_1_struct : public NativeExpressionAction {
	nat_src_side_bas_cycle_cpp_1_struct (ParentProcess *p, const djnn::string &n, bool string_setter, bool isModel)
      : NativeExpressionAction (p, n, isModel), _string_setter (string_setter)
    {
      set_is_model (isModel);
    ...
    void impl_deactivate () override {}
    void impl_activate () override;
	AbstractProperty * r_cycle;
	AbstractProperty * x_state;
};

void
nat_src_side_bas_cycle_cpp_1_struct::impl_activate ()
{
	r_cycle->set_value(((AbstractProperty*)r_cycle)->get_double_value () + (((AbstractProperty*)x_state)->get_double_value ()), 1);
};


struct nat_src_side_bas_cycle_cpp_2_struct : public NativeExpressionAction {
	nat_src_side_bas_cycle_cpp_2_struct (ParentProcess *p, const djnn::string &n, bool string_setter, bool isModel)
      : NativeExpressionAction (p, n, isModel), _string_setter (string_setter)
    {
      set_is_model (isModel);
...
void
nat_src_side_bas_cycle_cpp_2_struct::impl_activate ()
{
	fc_r->set_value(((AbstractProperty*)fc_g)->get_double_value () + (((AbstractProperty*)x_state)->get_double_value () * 4), 1);
};

ParentProcess*
side_bas_cycle (ParentProcess *p, const string &n, double d_var_0, double d_var_1)
{
	...
	auto* cpnt_4 = new Circle (cpnt_0, "cercle", d_var_0, d_var_1, 30);
	...
	alias (cpnt_0, "r_cycle", dynamic_cast<FatChildProcess*>(cpnt_4->find_child ("r")));
	auto *cpnt_7 = cpnt_0->find_child ( "r_cycle");
	...
	auto *cpnt_14 = new nat_src_side_bas_cycle_cpp_0_struct (cpnt_10, "", true, 0);
	...
	auto *cpnt_17 = new nat_src_side_bas_cycle_cpp_1_struct (cpnt_10, "", true, 0);
	if (cpnt_7->get_process_type() != PROPERTY_T) {
		djnn__error (cpnt_7, "is not a property\n");
		exit(0);
	}
		cpnt_17->r_cycle = dynamic_cast<AbstractProperty*>(cpnt_7);
	...
	auto *cpnt_20 = new nat_src_side_bas_cycle_cpp_2_struct (cpnt_10, "", true, 0);

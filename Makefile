...
# cpp example
exe := button
srcs_sma := src/Waypoint.sma src/Button.sma  src/Robot.sma src/Bombe.sma src/detour.sma src/side.sma src/side_bas.sma src/main.sma#srcs_sma := $(shell find $(src_dir) -name "*.sma")
